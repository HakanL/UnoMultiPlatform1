...
namespace App3.ViewModels
{
	public class MyFilesViewModel : ObservableObject, IInitialize
	{
		...
		void RegisterEvents()
		{
			...
			// To work around this, creating a new locally scoped property creates
			...
			var weakEventListener = new Shared.WeakEventListener<MyFilesViewModel, object, object>(this)
			{
